...
import {View, StyleSheet, Text, TouchableOpacity, Alert, Image, TextInput, Button } from 'react-native';
...
const NuevaOrden = () => {
  ...
  const handleCreateAccount = (userCredential) => {
    fire.auth().createUserWithEmailAndPassword(email2, password2).then(() =>{
