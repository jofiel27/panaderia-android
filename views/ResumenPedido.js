...
import { Text, Image, View, TouchableOpacity,Button, StyleSheet,TextInput,Alert } from "react-native";
...
import { launchImageLibrary } from "react-native-image-picker";
    ...
    const ResumenPedido = () => {
      ...
      const calcularTotal = () => {
        let nuevoTotal = 0;
        nuevoTotal = pedido.reduce( (nuevoTotal, artitulo) => nuevoTotal + artitulo.total, 0)
           ...
           <ScrollView style={globalStyles.contenedor}>
            <View style={globalStyles.contenido} >
                ...
                {pedido.map( (platillo, i) =>{
                    ...
                    return(
                        <View key={id + i}>
                         <TouchableOpacity style={globalStyles.BotonEliminar} onPress={() => ConfirmarEliminar(id)}> 
                         <Text style={globalStyles.textoBotonDetalle} >X</Text>
                         </TouchableOpacity>
                   
                        <Image style={globalStyles.imagenDetalle2} source={{uri: imagen}}/>
                        <View  style={globalStyles.contenido3}>
                        <Text style={globalStyles.titulo4}  >{Producto}</Text>
                        <Text style={globalStyles.tituloBold2} >Cantidad:<Text style={globalStyles.textoprecio}> {cantidad}</Text> </Text>
                        <Text style={globalStyles.tituloBold2} >Precio: <Text style={globalStyles.textoprecio} > Bs {precio}</Text></Text>
                ...
                <View style={globalStyles.contenido}>
                  ...
                  <Text style={globalStyles.tituloBold} >C.I: <Text style={globalStyles.descripcionDetalle}>XXXXXXXXXXX</Text></Text>
                  <Text style={globalStyles.tituloBold} >Banco: <Text style={globalStyles.descripcionDetalle}>XXXXXXXX</Text> </Text>
                  <Text style={globalStyles.tituloBold} >Telefono:<Text style={globalStyles.descripcionDetalle}> XXXXXX </Text></Text>
                </View>
                <View style={globalStyles.contenido}>
                  <Text style={globalStyles.titulo5}>Transferencias</Text>
                  <Text style={globalStyles.tituloBold} >C.I: <Text style={globalStyles.descripcionDetalle}>XXXXXXXXXXX</Text></Text>
                  <Text style={globalStyles.tituloBold} >Banco: <Text style={globalStyles.descripcionDetalle}>XXXXXXXX</Text> </Text>
                  <Text style={globalStyles.tituloBold} >Nombre:<Text style={globalStyles.descripcionDetalle}> XXXXXX </Text></Text>
                </View>
      ...
      <Text style={globalStyles.titulo5}  >Ingrese Numero de Referencia</Text>
            ...
            <View>
            <TouchableOpacity style={globalStyles.BotonDetalle} onPress={()=> progresoPedido() }>
               <Text style={globalStyles.textoBotonDetalle}>Comprobante de Pedido</Text>
            </TouchableOpacity>
            </View>
